...
class arguments:
    def __init__(self):
        self.model = "/home/ubuntu/catkin_ws/src/beacon_cam/src/yolov3/frozen_darknet_yolov3_model.xml"
        self.device = "MYRIAD"
        ...
        self.corner = [(578,152),(181,152)] #[(578.4,151.5),(181.2,151.5)]
    ...
    while (rs_isOpened(pipeline) \
        ...
        if next_frame_id_to_show in completed_request_results:
            ...
            for obj in objects:
                ...
                location = "{},{}".format(xp,yp) #not world axis
            ...
            #"""
                ...
                cv2.putText(frame,
                            "#" + det_label + ' ' + str(round(obj['confidence'] * 100, 1)) + ' % '+'({},{})->({},{})'.format(xavg, yavg, xp, yp),
